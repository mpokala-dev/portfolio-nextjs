const projects = [
  {
    ...
    description: "Production-quality task manager with TypeScript strict mode, inline editing, due dates, dark mode, and 93% test coverage with Vitest.",
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          {projects.map((project) => (
            <div key={project.title} className="bg-white rounded-2xl border border-gray-200 p-6 shadow-sm hover:shadow-md transition-shadow flex flex-col" >
